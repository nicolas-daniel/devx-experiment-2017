...
// ------- CUSTOM PASS
WAGNER.CustomPass = function() {

	WAGNER.Pass.call( this );
	WAGNER.log( 'CustomPass constructor' );
	this.loadShader( 'custom-fs.glsl' );

	this.params.divide = 1;
	this.params.mirrorX = 0;
	this.params.mirrorY = 0;
	this.params.morph = 0;
	// this.params.palettes = [];

};

WAGNER.CustomPass.prototype = Object.create( WAGNER.Pass.prototype );

WAGNER.CustomPass.prototype.run = function( c ) {

	this.shader.uniforms.divide.value = this.params.divide;
	this.shader.uniforms.mirrorX.value = this.params.mirrorX;
	this.shader.uniforms.mirrorY.value = this.params.mirrorY;
	this.shader.uniforms.morph.value = this.params.morph;
	// this.shader.uniforms.palettes.value = this.params.palettes;
	c.pass( this.shader );
