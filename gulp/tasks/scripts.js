...
const bundleProd = ( bundler, filename ) => {
    const startTime = process.hrtime(); // track when the task has started
    const banner = "console.log('                                                                                                    \n                                                                                                    \n                                                                                                    \n                                                                                                    \n                                                                                                    \n                                                                                      ``            \n             `/++++++++++++++++++++//////////////////////////////////////////////////:``   ./-+-    \n             `oyyyyyyyyyyyyyyyyyyyyyyyyyyyyyysyysssyyyyyyyyyyyyosyyyyyyyyyyyyyyyyyyyys-    ./`/.    \n             `oyyyyyyyyyyyyyyyyyyyyyyyyyyyyyysyysssyyyyyyyyyyyyosyyyyyyyyyyyyyyyyyyyys-    ./`/.    \n             `oyyyyyyyyyyyyyyyyyyyyyyyyyyyyyyys+:oyyyyyyyyyyys+./yyyyyyyyyyyyyyyyyyyys-    `o +.    \n             `oyyyyyyyyyyyyyyyyyyyyyyyyyyyyyso:.`:syyyyyyyyso:``+yyyyyyyyyyyyyyyyyyyys-    `. .     \n             `oyyyyyyyyyyyyyyyyyyyyyyyyyyyso/-````+syyyysso/-``-oyyyyyyyyyyyyyyyyyyyyy-    .-`.`    \n             `oyyyyyyyyyyyyyyyssyysyyso+so+:.```  .+ssss+/:.``./syyyyyyyyyysyyyyyyyyyy-    .:`:.    \n             `oyyyyyyyyyyyyyyssyyyyys+::/::-`..`````-::---.``--+sssosyssso++syyyyyyyyy-    .-`:.    \n             `oyyyyyyyyyyyysysssosss/-//:://:-`  `-````.--``--:/+/-.+yss:.`/syyyyyyyyy-    .-`-.    \n             `oyyyyyyyyysso+s/:y--::--//://:` `.``--``-::-:////:.``-os-o+./yyyyyyyyyyy-    .-`-.    \n             `oyyyyyyyyss+/:`.o+..``````-:.  `--.` `.-://////:-``./-+o.oo+syyyyyyyyyyy-    .-`-`    \n             `oyyyysysso+:. -s/`````.`.--`  `---.` ```.----:-``.-/:`+s-oysysyyyyyyyyyy-    .-`-`    \n             `oyyyyyss+/:` `oo+/`   `.-.    `..`     `.----``.--:/- .o+syyyyyyyyyyyyyy-       `     \n             `oyssyso//::`  ``````  .-``            .----``.-----..````+ssssoo++++ssyy-             \n             `oyyss+/-`.:/:.`  ````-.``           `.-:-. `.----.```````.....````-osyyy-             \n             `oyys+/-````.:/:-`   .-       ```` `.--:.``.-----.`             `-+ssysyy-             \n             `oss+.-.``````.-//-``:` ``   ```` `--::.``-----.`             `-oyyyyyyyy-             \n             `oyys/.`.```````.:///. `--`   `` `--:-``.---.`              `./syysyyyyyy-             \n             `oyyyso:.```````.:///.` `..`    `--::``.--.`               `./syysssyyyyy-             \n             `oyyys+::-```.-:///////:.`     `--::. .--.````           ```./osyyyyyyyyy-             \n             `oyyo/-::/..:-.--/////////-``  .--:-``--. ````       ````  ````..-:oyyyyy-             \n             `oyo//:--:::`  `.---:://////-.`---:- .--` ```      `````        `.:oyyyyy-             \n             `oys+--:::-``     ````.-://///:::::. ---`         `````        .:+ssyyyyy-             \n             `os+:::::.``      ``` `--/////////:``---`         `````      ./osyysyyyyy-             \n             .o+::-:-.``    ./+.```.-//////////-`./-.           `.```////:osyysyyyyyyy-             \n             ./---:-```   ``-+y.``.-//:////////////:```         ..```..syssysyyyyyyyyy-             \n            `:----:.````` ```/y``.-::--://///////////-.`        -`````/ysysyyyyyyyyyyy-             \n            .:+++///::-...```/y.---``-:/:-.``.--://////:.``    `-    -sysyyyyyyyyyyyyy-             \n             .sssssso/-..::-`-s--.``.--.````  .--:///////:-.`  `-    /yyyyyyyyyyyyyyyy-             \n             .syysyys+--:///---.```--.``````  `----////////:-`` .`   /syyyyyyyyyyyyyyy-             \n             .ssyyyso:-::://--.``.--.` `````   .----/////////:..:-`` /syyyyyyyyyyyyyyy:             \n             .sysyso/:--:///-```.-.` ``````     ``--::--..-:://////-./syyyyyyyyyyyyyyy/             \n             .syys+:-.-:///:```---. ```````      `-..````  .:++osssssssyyyyyyyyyyyyyyy/             \n             .sys+-..::///:``.-:::-. ``````  ````.````````./osssyyyyyyyyyyyyyyyyyyyyyy/             \n             .ss/:-/+oso/:``-::-::--. ```` ````.`````````-+syyyyyyyyyyysyyyyyyyyyyyyyy/             \n             .sooosssyyo/.-//:..----:. ```````.:-```````:osyyyyyyyyyyyyyyyyyyyyyyyyyyy/             \n             .syssssysso++os/-```-:+o-` ````..:+o:````./ssssssssssssssssssssssssssssss:             \n            ``-:----:-:::--::.`...----. ```.:-.---.``.--------------------------------.             \n                           -:-.`     -.`````       ``-`                                             \n                           --`       .````                                                          \n                           `         ` ``                                                           \n                                      .`                                                            \n                                                                                                    \n                                                                                                    \n                                                                                                    ');"; // prepare banner for the final file
